...
const Contact = () => {
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400 text-sm">ICCIS2026@gndu.ac.in</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400 text-sm">0183-282-3289 <br />Ext. 3201, (+91) 9501715960, (+91) 9815910666</p>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div className="absolute inset-0 bg-zinc-950/40 flex items-center justify-center backdrop-blur-sm group-hover:backdrop-blur-none group-hover:bg-transparent transition-all duration-500 z-10">
    <span className="px-4 py-2 bg-white dark:bg-zinc-900/80 rounded-lg text-sm text-zinc-700 dark:text-zinc-300 font-medium shadow-md">
  ...
  <iframe
    title="GNDU Location"
    src="https://www.google.com/maps?q=Guru+Nanak+Dev+University+Amritsar&output=embed"
